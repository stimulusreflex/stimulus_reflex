...
application_controller_src = fetch(templates_path + "/app/javascript/controllers/application_controller.js.tt")
application_controller_path = controllers_path / "application_controller.js"
application_js_src = fetch(templates_path + "/app/javascript/controllers/application.js.tt")
application_js_path = controllers_path / "application.js"
index_src = fetch(templates_path + "/app/javascript/controllers/index.js.importmap.tt")
