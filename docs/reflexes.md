...
* Reflex controller: an Stimulus controller that imports the StimulusReflex client library, it has a stimulate method for triggering Reflexes and like all Stimulus Controllers is aware of the element it is attached to, as well as any Stimulus targets in its DOM hierarchy
